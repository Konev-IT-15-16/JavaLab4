...
<h2>Цель работы</h2>
<p>Изучение обобщенных типов (generics) в Java, включая параметризацию, ограничения типов, обобщенные методы и коллекции. Реализация типизированных классов и методов с поддержкой различных сценариев использования.</p>
